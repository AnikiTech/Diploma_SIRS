    ...
    <v-app>
        <v-container grid-list-md text-xs-center>
            ...
            <v-layout>
                <v-flex>
                    <v-card outlined disabled>
                        <v-card-title primary-title>Запоминание цветов</v-card-title>
                        <v-card-subtitle>Настройки комплекса приложения</v-card-subtitle>
                        <v-divider/>
                        <v-list dense>
                            <v-list-item>
                                <v-list-item-content>
                                    <v-list-item-title>Настройки запоминания цветов</v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                        </v-list>
                    </v-card>
            ...
            <v-layout>
                <v-flex>
                    <v-card outlined disabled>
                        <v-card-title primary-title>Быстрое чтение</v-card-title>
                        <v-card-subtitle>Настройки комплекса приложения</v-card-subtitle>
                        <v-divider/>
                        <v-list dense>
                            <v-list-item>
                                <v-list-item-content>
                                    <v-list-item-title>Настройки быстрого чтения</v-list-item-title>
                                </v-list-item-content>
                            </v-list-item>
                        </v-list>
                    </v-card>
