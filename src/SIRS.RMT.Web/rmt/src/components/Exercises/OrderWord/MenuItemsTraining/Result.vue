...
<script>
    ...
    export default {
        ...
        methods: {
            // Words
            // base(user, questionsCount, correctAnswersCount, unknownAnswersCount, time, date)
            Runaway: function () {
                sendStatistic({
                  questionsCount: this.$store.getters.getExerciseData.words.length,
                    ...
                    type:1
                    //,
                    //time: this.$store.getters.getExerciseData.time,
                    //date: this.$store.getters.getExerciseData.date
                })
                this.$emit('Runaway');
            },
