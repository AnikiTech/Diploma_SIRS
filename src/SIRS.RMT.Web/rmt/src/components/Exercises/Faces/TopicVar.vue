          ...
          <v-card style="top:15%" max-width="750" class="mx-auto" outlined>
            ...
            <v-card-actions>
              <v-row justify="center" align="center">
                ...
                <v-col cols="12" sm="8">
                  <v-btn outlined block large color="primary" @click="$router.push({name: 'NameNP'})">Имя–отчество</v-btn>
                </v-col>
                <v-col cols="12" sm="8">
                  <v-btn outlined block large color="primary" @click="$router.push({name: 'FullName'})">ФИО</v-btn>
                </v-col>
                <v-col cols="12" sm="8">
                  <v-btn outlined block large color="primary" @click="$router.push({name: 'Faces'})">Выход</v-btn>
                </v-col>
              </v-row>
            </v-card-actions>
